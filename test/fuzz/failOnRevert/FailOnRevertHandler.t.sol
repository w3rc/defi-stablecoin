...
import {INRCEngine, AggregatorV3Interface} from "../../../src/INRCEngine.sol";
...
contract FailOnRevertHandler is Test {
    ...
    constructor(INRCEngine _engine, INRCoin _dsc) {
        engine = _engine;
        inrc = _dsc;
    ...
    function burnDsc(uint256 amountDsc) public {
        ...
        amountDsc = bound(amountDsc, 0, inrc.balanceOf(msg.sender));
        if (amountDsc == 0) {
            return;
        }
        engine.burnINRC(amountDsc);
    }
